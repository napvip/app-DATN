      ...
      <div className="flex-1 flex flex-col justify-center py-12">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to continue to BeeGuard</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-3 px-4 bg-card border border-border rounded-2xl hover:bg-muted transition-colors">
